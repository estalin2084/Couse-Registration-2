...
demoFile.close()
print("Congrats!! Your file has been saved into a file in", os.path.dirname("C:\Users\Estalin Pena\Desktop\Programming-_Tasks\Task-8-9-10\Couse-Registration-2\Test.txt"))
print("")
